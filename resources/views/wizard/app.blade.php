        ...
        <div class="w-full max-w-md mx-auto">
            ...
            <template x-if="visibleStep === 4 && data.status === 'completed'">
                <div class="space-y-6 animate-step" x-init="$nextTick(() => { celebrate(); certTab = 'fullchain'; })">
                    ...
                    <div class="border-t border-gray-100 pt-6 text-center space-y-3">
                        <p class="text-sm text-gray-500 text-balance">{{ __('wizard.donate_text') }}</p>
                        <a href="https://www.buymeacoffee.com/mapache" target="_blank" rel="noopener noreferrer" class="bmc-dark">
                            <svg fill="currentColor" aria-hidden="true"><use href="#bmc-icon"/></svg>
